...
interface GetAllFavoriteMealRequest{
    page: number
    limit: number
    meal_name?: string
...
export async function getAllFavoriteMeals(request: GetAllFavoriteMealRequest): Promise<ResponseProps<MealProps[]>>{
    let url = `/api/meal/favorite?page=${request.page}&limit=${request.limit}`
